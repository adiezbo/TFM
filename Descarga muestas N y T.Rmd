...
barcodes_LIHC
write.table(barcodes_LIHC, file = "barcodes_lihc.txt", sep = "\t", col.names = TRUE, row.names = TRUE, quote = F)

barcodes_LUAD <- str_sub(matched_tn_met_file_info_LUAD$file_name, 46, 64)
barcodes_LUAD
write.table(barcodes_LUAD, file = "barcodes_luad.txt", sep = "\t", col.names = TRUE, row.names = TRUE, quote = F)
...
### ESTUDIO BASICO DE DATOS DESCARGADOS ###
